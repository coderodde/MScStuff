 ...
 */
public final class RecursiveTarjanSCCFinder implements SCCFinder {
    ...
    public RecursiveTarjanSCCFinder() {}
    
    private RecursiveTarjanSCCFinder(final DirectedGraph digraph) {
    ...
    public List<List<Integer>> 
        ...
        return new RecursiveTarjanSCCFinder(digraph).compute();
    }
