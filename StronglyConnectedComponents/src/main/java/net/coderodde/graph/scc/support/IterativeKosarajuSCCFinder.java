 ...
 */
public final class IterativeKosarajuSCCFinder implements SCCFinder {
    ...
    public IterativeKosarajuSCCFinder() {}
    
    private IterativeKosarajuSCCFinder(final DirectedGraph digraph) {
    ...
    public List<List<Integer>> 
        ...
        return new IterativeKosarajuSCCFinder(digraph).compute();
    }
    ...
    private static void main(String[] args) {
        ...
        final SCCFinder finder = new IterativeKosarajuSCCFinder();
