...
public final class RecursiveKosarajuSCCFinder implements SCCFinder {
    ...
    public RecursiveKosarajuSCCFinder() {}

    private RecursiveKosarajuSCCFinder(final DirectedGraph digraph) {
    ...
    public List<List<Integer>>
        ...
        return new RecursiveKosarajuSCCFinder(digraph).compute();
    }
    ...
    private static void main(String[] args) {
        ...
        final SCCFinder finder = new RecursiveKosarajuSCCFinder();
